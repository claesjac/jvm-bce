...

{
    ...
    is (scalar @ifs, 2);
    is_deeply (shift @ifs, [7, 37, 'java/lang/Comparable']);
    is_deeply (shift @ifs, [8, 38, 'java/lang/Runnable']);
...

{
    ...
    is_deeply (shift @fields, [9, 11, 'quax', 12, 'Ljava/lang/Thread;']);    
}
